...
const contSummary = async (req, res) => {
    ...
    try {
        ...
        console.log('contSummary error: ', error);
...
const miniStatetsments = async (req, res) => {
    ...
    try {
        ...
        if (contribution.length == 0) {
            res.json({ msg: 'Your account is unfunded', code: 404 })

        } else {
            res.json({ contributions: contribution })
        }
...
module.exports = { contSummary, miniStatetsments, getStatement }
